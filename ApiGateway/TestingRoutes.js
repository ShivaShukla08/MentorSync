...
const sendnotification = require("../Controllers/GroupControllers/notifyMembers");
const updateGroupStatus = require("../Controllers/GroupControllers/updateStatus");

const router = express.Router();

router
  .route("/testingroutes/validrequest/:studentId")
  .get(testingControllers.UserLoginSuccessfull, validateGroupStudentRequest);

router
  .route("/changestatus/:groupId")
